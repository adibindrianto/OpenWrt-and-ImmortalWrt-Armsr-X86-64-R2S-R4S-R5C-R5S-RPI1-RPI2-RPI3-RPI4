...
# Set profile for Raspberry Pi 1
PROFILE="rpi"
...
ath9k-htc-firmware btrfs-progs hostapd hostapd-utils kmod-ath kmod-cfg80211 kmod-crypto-acompress kmod-crypto-crc32c kmod-crypto-hash kmod-fs-btrfs kmod-mac80211 \
