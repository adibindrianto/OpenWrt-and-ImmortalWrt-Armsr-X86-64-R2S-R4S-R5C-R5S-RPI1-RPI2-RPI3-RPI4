...
# Set profile for Raspberry Pi 3
PROFILE="rpi-3"
...
btrfs-progs kmod-ath kmod-cfg80211 kmod-crypto-acompress kmod-crypto-crc32c kmod-crypto-hash kmod-fs-btrfs kmod-mac80211 \
