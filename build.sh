...
PACKAGES="$PACKAGES base-files busybox dnsmasq dropbear firewall fstools jshn libblobmsg-json libiwinfo-lua libjson-c liblua libubox-lua libubus-lua logd mtd netifd odhcp6c odhcpd-base procd uci uclient-fetch uhttpd zlib"
