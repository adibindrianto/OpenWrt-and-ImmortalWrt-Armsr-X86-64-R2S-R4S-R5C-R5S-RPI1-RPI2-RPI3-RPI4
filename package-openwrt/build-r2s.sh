...
# Define packages
PACKAGES="luci-compat dnsmasq dnsmasq-full cgi-io libiwinfo libiwinfo-data libiwinfo-lua liblua \
...
ath9k-htc-firmware btrfs-progs hostapd kmod-ath kmod-ath9k kmod-ath9k-common kmod-ath9k-htc kmod-cfg80211 kmod-crypto-acompress kmod-crypto-crc32c kmod-crypto-hash kmod-fs-btrfs kmod-mac80211 \
...
kmod-fs-ntfs kmod-usb-storage kmod-usb-storage-extras \
kmod-nft-fib kmod-nft-bridge kmod-nft-nat \
blockd block-mount e2fsprogs fdisk parted blkid kmod-fs-cifs kmod-fs-exfat ntfs-3g ntfs-3g-utils gdisk tune2fs resize2fs losetup cfdisk f2fs-tools kmod-usb-storage-uas kmod-usb-ledtrig-usbport"
