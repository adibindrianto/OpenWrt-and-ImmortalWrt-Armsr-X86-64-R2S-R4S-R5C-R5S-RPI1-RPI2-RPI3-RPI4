...
# Define packages
PACKAGES="luci-lua-runtime cgi-io \
...
luci-theme-bootstrap rpcd-mod-luci \
rpcd-mod-rrdns usbutils htop \
...
kmod-usb-net-ipheth kmod-usb-net-cdc-mbim \
picocom \
ath9k-htc-firmware kmod-cfg80211 kmod-crypto-acompress kmod-crypto-crc32c kmod-crypto-hash kmod-fs-btrfs kmod-mac80211 \
...
block-mount e2fsprogs fdisk parted blkid kmod-fs-cifs kmod-fs-exfat ntfs-3g ntfs-3g-utils gdisk tune2fs resize2fs losetup cfdisk f2fs-tools kmod-usb-storage-uas kmod-usb-ledtrig-usbport"
